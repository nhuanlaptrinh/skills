...
## Quy Tac Rieng Cho Video ALT / Anh Lap Trinh

Áp dụng cho folder output và file MP4 khi tạo video trong nhà máy video ALT:

- Tên folder output và tên file video phải bắt đầu bằng số thứ tự, ví dụ `00_`, `01_`, `02_`.
- Tên folder output và tên file video phải kết thúc bằng kích thước video trước extension, ví dụ `_1280x720` hoặc `_720x1280`.
- Dùng lowercase, không dấu tiếng Việt, từ ngăn bằng `_`.
- Ví dụ folder: `02_tencent_edgeone_ai_agent_1280x720`.
- Ví dụ video: `02_tencent_edgeone_ai_agent_1280x720.mp4`.
- Nếu cần nhiều biến thể, thêm mô tả trước kích thước: `02_tencent_edgeone_ai_agent_final_1280x720.mp4`.
- Không dùng tên thiếu số đầu hoặc thiếu kích thước cuối như `tencent_edgeone_ai_agent_video.mp4` cho output mới.
